<div class="tab-pane fade" id="email">
    <form action="{{route('admin.email.settings', $setting->id)}}" method="POST" class="form-validate-jquery" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            <label class="col-lg-3 col-form-label">Mail Driver:</label>
            <div class="col-lg-9">
        ...
        <div class="form-group row">
            <label class="col-lg-3 col-form-label">SMTP Protocol:</label>
            <div class="col-lg-9">
        ...
        <fieldset>
            ...
            <div class="form-group ">
                ...
                <input class="form-control" id="mail_sendmail" placeholder="Mail Sendmail" name="mail_sendmail" type="text" value="/usr/sbin/sendmail -bs">

            </div>
            <div class="form-group ">
                <label for="mail_pretend" class="bold">Mail Pretend</label>
                <input class="form-control" id="mail_pretend" placeholder="Mail Pretend" name="mail_pretend" type="text" value="true">
        ...
        <fieldset>
            ...
            <div class="form-group ">
                ...
                <input class="form-control" id="mailgun_domain" placeholder="Mailgun Domain" name="mailgun_domain" type="text" value="your-mailgun-domain">

            </div>
            <div class="form-group ">
                <label for="mailgun_secret" class="bold">Mailgun Secret</label>
                <input class="form-control" id="mailgun_secret" placeholder="Mailgun Secret" name="mailgun_secret" type="text" value="your-mailgun-secret">
        ...
        <fieldset>
            ...
            <div class="form-group ">
                ...
                <input class="form-control" id="mandrill_secret" placeholder="Mandrill Secret" name="mandrill_secret" type="text" value="your-mandrill-secret">
        ...
        <fieldset>
            ...
            <div class="form-group ">
                ...
                <input class="form-control" id="sparkpost_secret" placeholder="Sparkpost Secret" name="sparkpost_secret" type="text" value="your-sparkpost-secret">
        ...
        <fieldset>
            ...
            <div class="form-group ">
                ...
                <input class="form-control" id="ses_key" placeholder="SES Key" name="ses_key" type="text" value="your-ses-key">

            </div>

            <div class="form-group ">
                <label for="ses_secret" class="bold">SES Secret</label>
                <input class="form-control" id="ses_secret" placeholder="SES Secret" name="ses_secret" type="text" value="your-ses-secret">

            </div>
            <div class="form-group ">
                <label for="ses_region" class="bold">SES Region</label>
                <input class="form-control" id="ses_region" placeholder="SES Region" name="ses_region" type="text" value="your-ses-region">
